 ...
 * 
 * jdm sez:
 * 	I commented out the displaying of the featured image and title, 
 *  so we could place and style those as we want via Toolset Content Templates and Views.
 * 
 * 	NOTE that terminlogy is confusing here: in "vanilla" WordPress, Views and Templates are PHP files in the Theme.  
 *  e.g., 'single.php' is the view to display single posts, and 'content.php' displays a particular content type.  Both
 *  are often extended with more specific files, where needed, e.g., 'single-flight.php' and/or 'content-flight.php'.
 *  
 *  With Toolset (and presumably the other plugins that exist to overcome this and other egregious WordPress inadequacies),
 *  we define Views and Content Templates using their (more) GUI tools.  This is a huge improvement, IMHO, but it then
 *  requires you to dig in the dirt of the Theme to override vestiges of the PHP approach.  
 *  	=> This is why we have a 'perlan' theme <=
 * 
 */

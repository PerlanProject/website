...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210316_perlandata_ff83477215cef4734700_20210523002841_archive.zip';
	const ARCHIVE_SIZE		 = '90401621';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ff83477-23002841';
    const SECONDARY_PACKAGE_HASH = 'c23d8a0-23002841';
	const VERSION			 = '1.4.0';
